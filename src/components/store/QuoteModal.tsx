...
import { ShieldCheck, FileText, ArrowRight, X } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
      ...
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden border-slate-200 dark:border-slate-800">
        <div className="bg-slate-950 p-10 flex flex-col items-center text-center relative">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-slate-400 text-lg">
              Continue to secure payment screen...
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          <div className="flex gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Industrial equipment often requires custom configurations. Our engineers will review your request and contact you within 4 business hours with a finalized quote and lead times.
              </p>
            </div>
          </div>
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-900 text-center border-t border-slate-100 dark:border-slate-800">
          <p className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold">
            KINETIX SECURE PROCUREMENT PORTAL
          </p>
        </div>
      </DialogContent>
    </Dialog>
