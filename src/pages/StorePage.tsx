...
export function StorePage() {
  ...
  const handleAddToCart = (id: string) => {
    ...
    toast.success(`${machine?.name} added to quote.`, {
      description: "You can view your quote request in the dashboard.",
    });
  };
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow">
        ...
        <div id="catalog" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl font-display font-bold">Equipment Catalog</h2>
              <p className="text-muted-foreground">Showing {filteredProducts.length} industrial solutions</p>
            </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="max-w-sm text-sm">
                Leading the global transition to autonomous manufacturing. Industrial excellence through precision engineering.
              </p>
            </div>
            <div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-900 text-xs flex justify-between">
            <p>© 2025 Kinetix Industrial Platforms Inc.</p>
